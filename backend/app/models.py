...
AuditLog) só resolve se a classe `Tenant` já tiver sido importada em algum
lugar do processo antes da primeira query — SQLAlchemy só enxerga classes
que o Python já executou. Como nada no caminho real da aplicação (só rotas
